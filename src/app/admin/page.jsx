...
const AdminDashboard = () => {
  ...
  const totalCategories = [...new Set(productsData?.map(p => p.category))].length || 0;
  ...
  const stats = [
    { name: 'Total Products', value: totalProducts, icon: '🛍️' },
    { name: 'Categories', value: totalCategories, icon: '📂' },
    { name: 'Total Value', value: `$${totalValue.toFixed(2)}`, icon: '💰' },
    { name: 'Active Products', value: totalProducts, icon: '✅' },
  ];
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            >
              ...
              <div className="mt-8">
                ...
                <p className="mt-2 text-sm text-gray-500">
                  Create a new product with images, descriptions, and pricing.
                </p>
              </div>
            </Link>
            ...
            >
              ...
              <div className="mt-8">
                ...
                <p className="mt-2 text-sm text-gray-500">
                  View, edit, and delete existing products in your catalog.
                </p>
              </div>
            </Link>
